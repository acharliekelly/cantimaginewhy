...
export const albumExplanations = {
  ...
  by selecting a vantage point adjacent to a public thoroughfare on a nice day, 
  ...
  artwork I made for my cousin's dorm room - it was the least I could do, after getting him hooked on my
  favorite comic book franchise.`,
  ...
  that "artist" was a term I might like to one day apply to myself. But I was OK with being good at geometry, and at following
  simple rules. So, I came up with a detailed process that ultimately came down to very simple rules (which I'm going to 
  ...
  to seriously change the shape or texture. Later, I found out about the French post-impressionist artist George Seurat and
  the Pointillist movement, though I suspect they got started for different reasons.`,
  ...
  the river, are spectacular. And then I discovered that both canvas and panel come in black.`,

  "miniature": `At some point, I got it into my head that making smaller paintings would mean less time commitment for 
  each piece. This turned out not to be the case. In fact, very small paintings took just as long as larger ones; I just
  had to use a smaller brush. I made a bunch of them, anyway. These are all either on 7" x 5" canvas, or 6" x 6" panels.`,

  "panorama": `Most of these pieces were created during my Sabbatical period, when all my work had to fit neatly into 
  ...
  high-qaulity artistic materials. The how and why of that experience is not particularly germaine; the relevant parts 
